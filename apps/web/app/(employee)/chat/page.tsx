...
export default function ChatPage() {
  ...
  function handleAccept() {
    logConsent.mutate({ module: 'ai_chat', action: 'grant' })
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)] max-w-2xl">
      <div className="mb-4">
        <h1 className="text-2xl font-bold">AI-finansassistent</h1>
        <p className="text-sm text-muted-foreground">
          Stil spørgsmål om din løn, skat og økonomi. Maks 20 beskeder per dag.
        </p>
      </div>
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center gap-3">
            ...
            <p className="text-muted-foreground text-sm max-w-sm">
              Hej! Jeg er din finansielle assistent. Spørg mig om din lønseddel, fradrag, pension
              eller andet om din økonomi.
            </p>
            <div className="flex flex-wrap gap-2 justify-center mt-2">
              {[
                'Hvad er AM-bidrag?',
                'Hvordan beregnes min A-skat?',
      ...
      <p className="text-xs text-muted-foreground mt-2 text-center">
        AI-assistenten giver finansiel viden — ikke investeringsrådgivning. Konsulter en rådgiver
        ved vigtige beslutninger.
      </p>
    </div>
  )
}
